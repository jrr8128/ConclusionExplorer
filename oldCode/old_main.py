...
def analyze_premises(truthTable, statementIndex, premises, statements, config):
    ...
    universalParticularOverlap = has_universal_particular_overlap(premises)
    ...
    isValidRecipe = (
        ...
        (not AEConflict) and
        (not universalParticularOverlap) and
        singleConclusion
    )
    ...
    diagnostics = {
        ...
        'universalParticularOverlap': universalParticularOverlap
    }
...
def has_universal_particular_overlap(premises):
    byPair = {}
