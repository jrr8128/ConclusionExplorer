...
class SemanticSpace:
    ...
    def check_all_s_are_p(regions_S_exists:int, regions_P_exists: int, all_regions_mask:int) -> bool:
        return regions_S_exists & SemanticSpace.regions_not_in(regions_P_exists, all_regions_mask) == 0

    @staticmethod
    def apply_all_s_are_p(regions_S_exists:int, regions_P_exists: int, all_regions_mask:int) -> int:
        return regions_S_exists & SemanticSpace.regions_not_in(regions_P_exists, all_regions_mask)
    ...
    @staticmethod
    def apply_no_s_are_p(regions_S_exists: int, regions_P_exists: int) -> int:
        return regions_S_exists & regions_P_exists
    ...
    @staticmethod
    def apply_some_s_are_p(regions_S_exists: int, regions_P_exists: int) -> int:
        return regions_S_exists & regions_P_exists
    ...
    @staticmethod
    def apply_some_s_are_not_p(regions_S_exists: int, regions_P_exists: int, all_regions_mask: int) -> int:
        return regions_S_exists & SemanticSpace.regions_not_in(regions_P_exists, all_regions_mask)
    ...
    def build_semantic_space(term_count: int) -> "SemanticSpace":
        ...
        region_term_assignments = SemanticSpace.build_region_term_assignments(region_count) 

        regions_where_term_is_true = SemanticSpace.build_regions_where_term_is_true(term_count, region_count, region_term_assignments)
